...
# Written by Iyad Ba Gari and Sophia Thomopoulos (enigma@ini.usc.edu)
...
echo "  grid-template-columns: repeat(10, 1fr);"                                        >> ${html_name}_coronal.html
echo "  gap: 2px;"                                                                      >> ${html_name}_coronal.html
...
for subj_id in `cat $subjectID`; do
    echo "<h1>${subj_id}</h1>"                                                           >> ${html_name}_coronal.html
	echo "<script> all_subs.push('${subj_id}.toString()'); </script>"					  >> ${html_name}_coronal.html
    echo "<div class=\"image-container\">"                                               >> ${html_name}_coronal.html
    echo "<img src=\"img/${subj_id}/coronal147.png\" width=\"100%\" loading=\"lazy\">"   >> ${html_name}_coronal.html
    echo "<img src=\"img/${subj_id}/coronal152.png\" width=\"100%\" loading=\"lazy\">"   >> ${html_name}_coronal.html
    echo "<img src=\"img/${subj_id}/coronal154.png\" width=\"100%\" loading=\"lazy\">"   >> ${html_name}_coronal.html
    echo "<img src=\"img/${subj_id}/coronal157.png\" width=\"100%\" loading=\"lazy\">"   >> ${html_name}_coronal.html
    echo "<img src=\"img/${subj_id}/coronal160.png\" width=\"100%\" loading=\"lazy\">"   >> ${html_name}_coronal.html
    echo "<img src=\"img/${subj_id}/sagittal84.png\" width=\"100%\" loading=\"lazy\">"   >> ${html_name}_coronal.html
    echo "<img src=\"img/${subj_id}/sagittal88.png\" width=\"100%\" loading=\"lazy\">"   >> ${html_name}_coronal.html
    echo "<img src=\"img/${subj_id}/sagittal94.png\" width=\"100%\" loading=\"lazy\">"   >> ${html_name}_coronal.html
    echo "<img src=\"img/${subj_id}/sagittal97.png\" width=\"100%\" loading=\"lazy\">"   >> ${html_name}_coronal.html
    echo "<img src=\"img/${subj_id}/sagittal113.png\" width=\"100%\" loading=\"lazy\">"  >> ${html_name}_coronal.html
    echo "</div>"                                                                        >> ${html_name}_coronal.html
    echo "<button onclick=\"saveSubjectIDs(${subj_id})\">Save Subject ID</button>"       >> ${html_name}_coronal.html
done;
...
echo "function saveSubjectIDs(subj_id) {"                                               >> ${html_name}_coronal.html
echo "  var filename = 'subjectIDs_failed.txt';"                                        >> ${html_name}_coronal.html
echo "  var data = subjectIDs.push(subj_id.toString());"                                           >> ${html_name}_coronal.html
echo "  console.log(subj_id);"															>> ${html_name}_coronal.html
echo "}"                                                                                >> ${html_name}_coronal.html
echo "function makeCSV(){"																>> ${html_name}_coronal.html
echo "	// Get Intersection of arrays"													>> ${html_name}_coronal.html
...
echo "			data.push(all_subs[i] + ',No\n');"										>> ${html_name}_coronal.html
echo "		}"																	        >> ${html_name}_coronal.html
echo "		else{"																	    >> ${html_name}_coronal.html
echo "			data.push(all_subs[i] + ',Yes\n');"										>> ${html_name}_coronal.html
echo "		}"																	        >> ${html_name}_coronal.html
echo "	}"																	            >> ${html_name}_coronal.html
echo "	// Create new file and download"												>> ${html_name}_coronal.html
echo "	const file = new File(data, 'AC3_QC.csv', {type: \"text/plain\"});"			    >> ${html_name}_coronal.html
